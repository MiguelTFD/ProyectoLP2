...
import cl.dci.eshop.auth.UserService;
...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .csrf().disable()
                .authorizeRequests()
                .antMatchers("/", "/index", "/img/**", "/fonts/**", "/scss/**", "/css/**", "/js/**", "/lib/**", "/user", "/catalogo", "/producto/**", "/home", "/poblamiento", "/api/**", "/registro","/api/producto", "/api/usuario/registrar").permitAll()
