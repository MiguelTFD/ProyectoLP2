...
public class TemplateController {
    ...
    private void poblarBd() {
        ...
        Producto p1 = new Producto("Producto 1", 2000,"producto de preuba",23);
        Producto p2 = new Producto("Producto 2", 2500,"producto de preuba",23);
        Producto p3 = new Producto("Producto 3", 3000,"producto de preuba",23);
        Producto p4 = new Producto("Producto 4", 5000,"producto de preuba",23);
